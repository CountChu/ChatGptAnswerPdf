...
* Recover OP-TEE ```(230327.OP-TEE.txt)```
...
## OP-TEE.0327.md
**Question:** `[09:38]` How to recovery the dead OP-TEE? `(OP-TEE.0327.md)`
...
**Question:** `[10:23]` Hot to detect if OP-TEE is tamperred at run-time? `(OP-TEE.0327.md)`
...
## TrustZone.0329.md
**Question:** `[14:19]` What is differenct between Armv8-A and Armv8-M `(TrustZone.0329.md)`
