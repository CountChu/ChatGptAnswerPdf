...
## Papers.OP-TEE.0406.md
**Question:** What does the paper "Bao: A Lightweight Static Partitioning Hypervisor for Modern Multi-Core Embedded Systems" talk about? Virtualization, TEE or TrustZone?
...
**Question:** Is OP-TEE required in TrustedVIM described in the page "Cloud & Edge Trusted Virtualized Infrastructure Manager (VIM) - Security and Trust in OpenStac"
...
## TrustZone.0329.md
**Question:** Is OP-TEE a kind of TCB?
...
## OP-TEE.0327.md
**Question:** Please list history with years of TEE, TrustZone, and OP-TEE.
...
**Question:** Please also contain the iPhone about TrustZone.
...
**Question:** Please also contain qualcomm about TrustZone.
...
**Question:** What is difference between QSEE and QTEE?
...
## OP-TEE.History.0407.md
**Question:** Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone and Qualcomm about TustZone.
...
**Question:** Please display them in a table. Columns of the table are TEE, TrustZone, OP-TEE, iPhone and Qualcomm.
...
**Question:** Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone and Qualcomm about TustZone. Please also contain ARM7 and ARM8. The history of OP-TEE must be detail.
...
**Question:** Please display above context in a table. Columns of the table are TEE, ARM TrustZone, OP-TEE, iPhone and Qualcomm.
