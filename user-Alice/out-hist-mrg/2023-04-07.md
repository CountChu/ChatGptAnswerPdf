...
* 2020 Bao @ Papers.OP-TEE.0406.md
    * `[09:02]` Is Bao a hypervisor?
* Hypervisor & Virtualization @ Papers.OP-TEE.0406.md
    * `[09:04]` Please compare hypervisor and virtualization and also summarize them in a table.
    * `[09:05]` Is TrustZone a hypervisor or virtualization?
    * `[09:06]` Is OP-TEE a hypervisor or virtualization?
    * `[09:07]` Does virtualization depend on hypervisor?
    * `[14:05]` Are there alnatives of hypervisor?
* VM @ Papers.OP-TEE.0406.md
    * `[13:56]` Does VM require hypervisor?
    * `[14:07]` Can a VM contain VMs?
* Virtualization @ Papers.OP-TEE.0406.md
    * `[13:59]` What are types of virtualization techs?
* Hypervisor @ Papers.OP-TEE.0406.md
    * `[14:04]` Is hypvervisor a virtual machine manager?
* TCB @ TrustZone.0329.md
    * `[16:32]` What are components in TCB?
* History @ OP-TEE.History.0407.md
    * `[21:23]` Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone about TrustZone and Qualcomm about TEE. Please also contain ARM7 and ARM8. The history of OP-TEE must be detail.
    * `[21:26]` Please display above context in a table. X axis of the table are TEE, ARM TrustZone, OP-TEE, iPhone and Qualcomm.  Y asis of the table are years.
    * `[21:30]` When did Qualcomm release QTEE?
    * `[21:36]` Please list history of Qualcomm TEE with years in detail.
    * `[21:40]` Where do you find the year when Qualcomm introduced QTEE?

---

# Chats
* Papers.OP-TEE.0406.md
    * `[08:09]` What does the paper "Bao: A Lightweight Static Partitioning Hypervisor for Modern Multi-Core Embedded Systems" talk about? Virtualization, TEE or TrustZone?
    * `[08:18]` Is OP-TEE required in TrustedVIM described in the page "Cloud & Edge Trusted Virtualized Infrastructure Manager (VIM) - Security and Trust in OpenStac"
* TrustZone.0329.md
    * `[16:31]` Is OP-TEE a kind of TCB?
    * `[16:31]` Is secure boot a TCB?
* OP-TEE.0327.md
    * `[16:55]` Please list history with years of TEE, TrustZone, and OP-TEE.
    * `[16:58]` Please also contain the iPhone about TrustZone.
    * `[17:00]` Please also contain qualcomm about TrustZone.
    * `[17:03]` When did Qualcomm release QTEE?
    * `[17:06]` What is difference between QSEE and QTEE?
* OP-TEE.History.0407.md
    * `[21:14]` Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone and Qualcomm about TustZone.
    * `[21:16]` Please display them in a table. Columns of the table are TEE, TrustZone, OP-TEE, iPhone and Qualcomm.
    * `[21:21]` Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone and Qualcomm about TustZone. Please also contain ARM7 and ARM8. The history of OP-TEE must be detail.
    * `[21:25]` Please display above context in a table. Columns of the table are TEE, ARM TrustZone, OP-TEE, iPhone and Qualcomm.

---

# Q & A
## 2020 Bao @ Papers.OP-TEE.0406.md
**Question:** `[09:02]` Is Bao a hypervisor?
...
## Hypervisor & Virtualization @ Papers.OP-TEE.0406.md
**Question:** `[09:04]` Please compare hypervisor and virtualization and also summarize them in a table.
...
**Question:** `[09:05]` Is TrustZone a hypervisor or virtualization?
...
**Question:** `[09:06]` Is OP-TEE a hypervisor or virtualization?
...
**Question:** `[09:07]` Does virtualization depend on hypervisor?
...
**Question:** `[14:05]` Are there alnatives of hypervisor?
...
## VM @ Papers.OP-TEE.0406.md
**Question:** `[13:56]` Does VM require hypervisor?
...
**Question:** `[14:07]` Can a VM contain VMs?
...
## Virtualization @ Papers.OP-TEE.0406.md
**Question:** `[13:59]` What are types of virtualization techs?
...
## Hypervisor @ Papers.OP-TEE.0406.md
**Question:** `[14:04]` Is hypvervisor a virtual machine manager?
...
## TCB @ TrustZone.0329.md
**Question:** `[16:32]` What are components in TCB?
...
## History @ OP-TEE.History.0407.md
**Question:** `[21:23]` Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone about TrustZone and Qualcomm about TEE. Please also contain ARM7 and ARM8. The history of OP-TEE must be detail.
...
**Question:** `[21:26]` Please display above context in a table. X axis of the table are TEE, ARM TrustZone, OP-TEE, iPhone and Qualcomm.  Y asis of the table are years.
...
**Question:** `[21:30]` When did Qualcomm release QTEE?
...
**Question:** `[21:36]` Please list history of Qualcomm TEE with years in detail.
...
**Question:** `[21:40]` Where do you find the year when Qualcomm introduced QTEE?
...
## Papers.OP-TEE.0406.md
**Question:** `[08:09]` What does the paper "Bao: A Lightweight Static Partitioning Hypervisor for Modern Multi-Core Embedded Systems" talk about? Virtualization, TEE or TrustZone?
...
**Question:** `[08:18]` Is OP-TEE required in TrustedVIM described in the page "Cloud & Edge Trusted Virtualized Infrastructure Manager (VIM) - Security and Trust in OpenStac"
...
## TrustZone.0329.md
**Question:** `[16:31]` Is OP-TEE a kind of TCB?
...
**Question:** `[16:31]` Is secure boot a TCB?
...
## OP-TEE.0327.md
**Question:** `[16:55]` Please list history with years of TEE, TrustZone, and OP-TEE.
...
**Question:** `[16:58]` Please also contain the iPhone about TrustZone.
...
**Question:** `[17:00]` Please also contain qualcomm about TrustZone.
...
**Question:** `[17:03]` When did Qualcomm release QTEE?
...
**Question:** `[17:06]` What is difference between QSEE and QTEE?
...
## OP-TEE.History.0407.md
**Question:** `[21:14]` Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone and Qualcomm about TustZone.
...
**Question:** `[21:16]` Please display them in a table. Columns of the table are TEE, TrustZone, OP-TEE, iPhone and Qualcomm.
...
**Question:** `[21:21]` Please list history with years of TEE, TrustZone, and OP-TEE. Please also contain iPhone and Qualcomm about TustZone. Please also contain ARM7 and ARM8. The history of OP-TEE must be detail.
...
**Question:** `[21:25]` Please display above context in a table. Columns of the table are TEE, ARM TrustZone, OP-TEE, iPhone and Qualcomm.
