...
* MRSIGNER @ Papers.SGX.0419.md
    * `[10:19]` What is enclave identity described in the paper? <span style="color:red">`[error]`</span>
...
* Launch Enclave @ Slides.SGX.0420.md
    ...
    * `[15:13]` Does the binary of Launch Enclave reside in BIOS or ME? <span style="color:blue">`[title]`</span>
...
## MRSIGNER @ Papers.SGX.0419.md
**Question:** `[10:19]` What is enclave identity described in the paper? <span style="color:red">`[error]`</span>
...
**Question:** `[15:13]` Does the binary of Launch Enclave reside in BIOS or ME? <span style="color:blue">`[title]`</span>
...
## SGX.0418.md
**Question:** `[09:23]` Is UEFI Secure Boot a hardware or software attestation?
...
## Papers.SGX.0419.md
**Question:** `[10:19]` What is data structure of enclave identity in C language?
...
**Question:** `[10:31]` Where does the paper describe "The enclave identity is a combination of the MRENCLAVE value"?
...
**Question:** `[10:36]` Who does generate MRSIGNER?
...
**Question:** `[10:55]` When does the enclave builder enroll SIGSTRUCT into hardware?
...
**Question:** `[10:57]` Please explain the sentence in the paper: "The enclave builder presents the hardware with an RSA signed enclave certificate (SIGSTRUCT)"
...
**Question:** `[14:21]` Does Intel EPID require TPM?
...
## Slides.SGX.0420.md
**Question:** `[16:16]` How does the Solution 1 "Privacy CA for provisioning ak" work with Intel SGX? Please list the steps.
