...
* Sealing Authority ```(230418.SGX.yaml)```
...
* Attestation Assertion ```(230418.SGX.yaml)```
...
## Papers.SGX.0419.md
**Question:** Is Sealing Auhority a software or a hardware?
...
**Question:** Is Sealing Authority a software or a hardware?
...
**Question:** What is attestation key?
...
**Question:** How to generate attestation key?
...
**Question:** Is there only one attestation key in a device?
...
**Question:** Where is attestation key sotred in Intel SGX arch?
...
**Question:** Who creates an enclave?
...
**Question:** How to get the MRENCLAVE value of an enclave?
