...
* Attestation Key @ SGX.0418.md
    * `[09:50]` Where is attestation key sotred in Intel SGX arch? <span style="color:red">`[error]`</span>
...
* Enclave @ Papers.SGX.0419.md
    * `[14:28]` Can untrusted software create an enclave? <span style="color:blue">`[title]`</span>
...
## Attestation Key @ SGX.0418.md
**Question:** `[09:50]` Where is attestation key sotred in Intel SGX arch? <span style="color:red">`[error]`</span>
...
## Enclave @ Papers.SGX.0419.md
**Question:** `[14:28]` Can untrusted software create an enclave? <span style="color:blue">`[title]`</span>
