...
* TrustZone & HSM
    ...
    * Is HSM cost than TrustZone? `(2023-04-11)` `(TrustZone.0329.md)`
    * Is HSM more performance than ARM TrustZone in crypto operations? `(2023-04-11)` `(TrustZone.0329.md)`
    * What are security certifications of TrustZone? `(2023-04-11)` `(TrustZone.0329.md)`
...
* Boot
    ...
    * What is FF-A? `(2023-04-10)` `(TrustZone.0329.md)`
    * Does TF-A rely on FF-A? `(2023-04-10)` `(TrustZone.0329.md)`
    * Does TF-A rely on TrustZone? `(2023-04-10)` `(TrustZone.0329.md)`
* Memory
...
* Secure Partition
    ...
    * Can I create a SP in run-time? `(TrustZone.0329.md)`
...
* Privilege Levels
    ...
    * What is exception level? `(2023-04-10)` `(TrustZone.0329.md)`
    * How does a software component know which EL it owns? `(2023-04-10)` `(TrustZone.0329.md)`
    * Can a software component change the EL? `(2023-04-10)` `(TrustZone.0329.md)`
    * Are ELs of TrustZone? `(2023-04-10)` `(TrustZone.0329.md)`
    * Are EL3 and S-EL3 same? `(2023-04-13)` `(TrustZone.0329.md)`
...
**Question:** Can TrustZone totally replace HSM? `(TrustZone.0329.md)`
...
**Question:** Is HSM cost than TrustZone? `(2023-04-11)` `(TrustZone.0329.md)`
...
**Question:** Is HSM more performance than ARM TrustZone in crypto operations? `(2023-04-11)` `(TrustZone.0329.md)`
...
**Question:** What are security certifications of TrustZone? `(2023-04-11)` `(TrustZone.0329.md)`
...
**Question:** What is FF-A? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** Does TF-A rely on FF-A? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** Does TF-A rely on TrustZone? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** What is differenct between Armv8-A and Armv8-M? Please summarize as a table. `(TrustZone.0329.md)`
...
**Question:** What is exception level? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** How does a software component know which EL it owns? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** Can a software component change the EL? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** Are ELs of TrustZone? `(2023-04-10)` `(TrustZone.0329.md)`
...
**Question:** Are EL3 and S-EL3 same? `(2023-04-13)` `(TrustZone.0329.md)`
