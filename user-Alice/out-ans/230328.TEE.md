...
* Basic Concepts
    ...
    * How do I check the TEE OS is secure. Are there any secure certificates of TEE OS? `(2023-04-14)` `(TEE.0328.md)`
    * Does OP-TEE mach the certificates? `(2023-04-14)` `(TEE.0328.md)`
* CA & TA
...
* TEE Identification
    * What is TEE identification? `(2023-04-10)` `(TEE.0328.md)`
    * Is TEE identification obversable? `(2023-04-10)` `(TEE.0328.md)`
    * Can I use DID as TEE identification? `(2023-04-10)` `(TEE.0328.md)`
* Revocation of TA
    * What is revocation for Trusted Application? `(2023-04-10)` `(TEE.0328.md)`
...
**Question:** How do I check the TEE OS is secure. Are there any secure certificates of TEE OS? `(2023-04-14)` `(TEE.0328.md)`
...
**Question:** Does OP-TEE mach the certificates? `(2023-04-14)` `(TEE.0328.md)`
...
## TEE Identification
**Question:** What is TEE identification? `(2023-04-10)` `(TEE.0328.md)`
...
**Question:** Is TEE identification obversable? `(2023-04-10)` `(TEE.0328.md)`
...
**Question:** Can I use DID as TEE identification? `(2023-04-10)` `(TEE.0328.md)`
...
## Revocation of TA
**Question:** What is revocation for Trusted Application? `(2023-04-10)` `(TEE.0328.md)`
