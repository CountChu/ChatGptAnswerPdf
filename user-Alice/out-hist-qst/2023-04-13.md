...
# Questions
* Types of ARM CPU @ Arm.0410.md
    * `[09:13]` Below ariticle "In aarch32 state, what is the mechanism to switch to aarch64 in software?" come from
    * `[09:17]` How do I specify only AArch32 of Armv8-A at run-time?
    * `[09:34]` Is uboot 32-bit or 64-bit?
* 1 - Introduction @ EME.0413.md
...
# Q & A
## Types of ARM CPU @ Arm.0410.md
**Question:** `[09:13]` Below ariticle "In aarch32 state, what is the mechanism to switch to aarch64 in software?" come from
