# 230413.EME
Created: 2023-04-16 18:40:06
# Questions
* Abstract & Status of This Document
    * The below text is "Abstract" and "Status of This Document" chapters of https://www.w3.org/TR/encrypted-media (2023-04-13)
* 1 - Introduction
    * The below text is "1. Introduction" chapter of https://www.w3.org/TR/encrypted-media (2023-04-13)
    * What is CDN? (2023-04-13)
    * What is Media Stack? (2023-04-13)
    * What is MediaKeySession? (2023-04-13)
    * Which components does MediaKeySession contain? (2023-04-13)
    * Does Media Stack contain many MediaKeySession? (2023-04-13)
    * Where do frames exist in Encrypted Media Extensions? (2023-04-13)
* 2 - Definitions
    * The below text is "2. Definitions" chapter of https://www.w3.org/TR/encrypted-media (2023-04-13)
    * The below text is the second part of "2. Definitions" chapter of https://www.w3.org/TR/encrypted-media (2023-04-13)

---

# Q & A
## Abstract & Status of This Document
**Question:** The below text is "Abstract" and "Status of This Document" chapters of https://www.w3.org/TR/encrypted-media (2023-04-13)
...
## 1 - Introduction
**Question:** The below text is "1. Introduction" chapter of https://www.w3.org/TR/encrypted-media (2023-04-13)
...
**Question:** What is CDN? (2023-04-13)
...
**Question:** What is Media Stack? (2023-04-13)
...
**Question:** What is MediaKeySession? (2023-04-13)
...
**Question:** Which components does MediaKeySession contain? (2023-04-13)
...
**Question:** Does Media Stack contain many MediaKeySession? (2023-04-13)
...
**Question:** Where do frames exist in Encrypted Media Extensions? (2023-04-13)
...
## 2 - Definitions
**Question:** The below text is "2. Definitions" chapter of https://www.w3.org/TR/encrypted-media (2023-04-13)
...
**Question:** The below text is the second part of "2. Definitions" chapter of https://www.w3.org/TR/encrypted-media (2023-04-13)
